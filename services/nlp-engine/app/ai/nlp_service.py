        ...
        try:
            ...
            return {
                ...
                "metadata": {
                    ...
                    "has_subqueries": len(complex_query.subqueries),
                    "has_joins": len(complex_query.joins),
                    "has_unions": len(complex_query.unions),
                    "subquery_types": [sq.purpose for sq in complex_query.subqueries],
                    "join_types": [j.join_type for j in complex_query.joins],
