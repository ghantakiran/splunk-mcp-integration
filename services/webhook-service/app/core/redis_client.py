"""
Redis client configuration and connection management for Webhook Service.
"""
...
class RedisRateLimiter:
    ...
    async def is_allowed(
        ...
        Args:
            key: Rate limit key (e.g., user_id, endpoint_id)
...
class RedisQueue:
    """Redis-based queue for webhook delivery."""
